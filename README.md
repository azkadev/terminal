...
1. [Alpine Linux](https://github.com/azkadev/linux-dev/) **TESTED WORK 100%** **Butuh Akses Root**
2. [Ubuntu Linux](https://github.com/azkadev/linux-dev/) **TESTED WORK 100%** **Butuh Akses Root**
